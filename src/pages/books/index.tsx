            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>author</Th>
                  <Th>price</Th>
                  {hasAccess('bookseller', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>bookseller</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>{record.author}</Td>
                    <Td>{record.price}</Td>
                    {hasAccess('bookseller', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/booksellers/view/${record.bookseller?.id}`}>
                          {record.bookseller?.name}
                        </Link>
                      </Td>
                    )}
